...
public class ElmSaver1_4 implements Saver<Element> {
	...
	public void save(OutputStream out, Element elm) {
		...
		boolean showProgress = elm.isShowProgress();
	...
	public Element load(BufferedReader in) throws LoadException {
		try{
			...
			showProgress=Boolean.parseBoolean(in.readLine());
