...
public class ExpenceRenderer extends Renderer implements ActionListener,
	ChangeListener {
    ...
    public ExpenceRenderer(Element elm, Main main) {
	super(elm, main);
	...
	bar = new ProgressBar(elm.getTotal(), 0, elm.getAmountSpentOn(), false,
		new Color(120, 220, 140), new Color(235, 110, 70),new Color(255,80,70),new Color(80, 180, 140),elm.isShowProgress());
